  ...
  return (
    ...
    className="w-screen h-screen flex items-center justify-center bg-gray-100 ">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded w-96 shadow-[0px_0px_20px_3px_#f7fafc]">
        ...
        <label className="block mb-2">Email Address <sup className='text-red-500 text-sm'>*</sup></label>
        <input
          type="email"
          required
          value={email}
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition-colors duration-300 cursor-pointer"
        >
